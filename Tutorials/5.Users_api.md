# 🧑‍💻 User Management (Create + Upload Avatar + Validation + Delete User)

- How to build a **User Registration Workflow** in Express.js using **Mongoose**, **Multer**, **Express-validator**, and **Custom Middlewares**.?


# 1️⃣ Create Mongoose User Schema (`models/people.js`)
...
// Export as model (MongoDB will create 'people' collection automatically)
module.exports = mongoose.model("People", peopleSchema);
```

---

# 2️⃣ Add Avatar Upload Middleware (`middleware/users/avatarUpload.js`)

We need **multer** to handle image uploads.

This middleware will call the **singleUploader** function.
...
# 3️⃣ Create the Multer Upload Utility (`utilities/singleUploader.js`)
...
# 4️⃣ Create User Validation Middleware
...
# 5️⃣ Create addUser and deleteUser in `controllers/usersController.js`
...
# 6️⃣ Setup Routes (`routers/userRouter.js`)
...
* name, email, mobile, password → `req.body`
* avatar → `req.files`
...
2. If avatar exists → deletes file from uploads folder
